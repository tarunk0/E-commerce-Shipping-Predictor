...
def predict():
    ...
    if request.method == 'POST':
        ...
        if output == 0:
            return render_template('index.html',prediction_text="Yayy! Your order will reach on time")
        elif output == 1:
            return render_template('index.html',prediction_text="Sorry, Your order probably won't reach on time")
    else:
        return render_template('index.html')
